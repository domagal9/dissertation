...
// [[Rcpp::export]]
double scobit_loglike_cpp_i(NumericVector x1, NumericVector x2, NumericVector y,
...
// [[Rcpp::export]]
NumericVector scobit_loglike_gr_cpp_i(NumericVector x1, NumericVector x2, NumericVector y,
                                    NumericVector params){
  int n = x1.length();
  double b0 = params[0];
  double b1 = params[1];
